...
3. **`RequestAuditLog`**
   - Belongs to a `WorkflowRequest` and tracks the historical footprint of _who_ did _what_ and _when_.
4. **`Attachment`**
...
_Document prepared under Senior Software Engineering standards. Suitable for final project submission and architecture review._
